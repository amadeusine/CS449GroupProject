...
\hypersetup{
 ...
 pdftitle={CS449 Sprint 3 Report},
 pdfkeywords={},
 pdfsubject={},
...
\label{sec:org484d93f}
\begin{itemize}
\item Current User Stories are pseudo-Epics and need to be refined into better User stories aside
from \hyperref[sec:org2940434]{S1}. As they stand, discussing the current user stories makes for overly generic/abstract
...
\label{sec:org0fb182f}
\begin{itemize}
\item Duration: 2 hour
\item Location: Miller Nichols Library
\end{itemize}
\subsubsection*{Agenda}
\label{sec:org610bd2a}
\begin{itemize}
...
\label{sec:orge1d95ef}
\begin{itemize}
\item bugs
\label{sec:orgaace289}
\begin{itemize}
...
\label{sec:org2f8ecdd}
\begin{itemize}
\item Duration: 2 hours
\item Location: Miller Nichols Library
\end{itemize}
\subsubsection*{Agenda}
\label{sec:orgfb0092e}
\begin{itemize}
...
\label{sec:org278f256}
\begin{itemize}
\item duration: 2 hours
\item Location: Miller Nichols Library
\end{itemize}
\subsubsection*{Agenda}
\label{sec:org8139a8d}
\begin{itemize}
